...
namespace VRTK
{
    ...
    public partial class SDK_PlayStationVRInput
    {
        ...
        [Tooltip("SimulatorInput")]
        public bool SimulatorInput;
        ...
        [SerializeField]
        private float controllerRadiusLimit = 1;
        ...
        private void SetUpEditorSimulator()
        {
            ...
            var keyMappings = new Dictionary<PlayStationKeys, KeyCode>
            {
                {Trigger, triggerAlias},
                {TouchPad, touchpadAlias},
                {GripButton, gripAlias},
                {ButtonOne, buttonOneAlias},
                {ButtonTwo, buttonTwoAlias},
                {ButtonStart, startMenuAlias},

                //{PlayStationKeys.Triangle, touchModifier},
            };
